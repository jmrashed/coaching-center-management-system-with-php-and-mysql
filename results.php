            ...
            <section class="content">
                <div class="box col-xs-12">
                    <div class="row text-center">
                        <h2 class="coachinname">FAMOUS ACADEMIC COACHING, JHENAIDAH</h2>
                        <span class="coachinaddress">Behind the pouro park, Shahid Alamgir road, Jhenaidah, Bangladesh</span>
                        ...
                        <form action="savemark.php" method="post" class=" form-horizontal">
                            ...
                            <table class="table table-bordered table-striped"> 
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    $count++;
                                    ?>
                                    <tr> <td><?= $row['id']; ?></td><td> <?= $row['fullname']; ?></td> <td> 
                                ...
                                while ($row = $result->fetch_assoc()) {
                                  ...
                                  //  echo $row["mark"].'---->'.$gradePoint.'<br>';
                                    ...
                                    <tr>
                                        ...
                                        <td class="ng-binding"><?= $row["fullname"]; ?></td> 
