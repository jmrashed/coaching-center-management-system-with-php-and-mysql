...
if (isset($_POST['submit'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header('Location:classes.php?Message= A new class has been Saved. ');
    } else {
        echo "Error: " . $sql . "<br>" . $conn->error;
    }
}
        ...
        <section class="content">
            <div class="box col-xs-12">
                <div class="box-header">
                    ...
                    <h3 class="box-title ng-binding">Add Class</h3>
                </div>
                <div class="box-body">
                    <form class="form-horizontal " method="post" action="classes.php" >
                        <div class="form-group has-error" >
                            <label for="inputEmail3" class="col-sm-2 control-label ng-binding">Class Name * </label>
                            <div class="col-sm-10">
                                <input type="text" name="className"   
                                       class="form-control ng-pristine ng-invalid ng-invalid-required" required=""
                                       placeholder="Subject Name" value="<?= $className; ?>">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10"> 
                                <?php if (isset($_GET['editclass'])) { ?>
                                    <input type="submit" class="btn btn-primary ng-binding" value="Update class" name="update" >
                                <?php } else { ?>
                                    <input type="submit" class="btn btn-primary ng-binding" value="Add class" name="submit" >
    <?php } ?>
...
<?php } ?> 
        ...
        <a href="classes.php?addclass=yes"  class="floatRTL btn btn-success btn-flat pull-right marginBottom15 no-print ng-binding">Add class</a>
        ...
        <div class="box col-xs-12">
            <div class="box-header">
                <h3 class="box-title ng-binding">List classes</h3>
